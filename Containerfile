...
RUN pacman -Sy --noconfirm base dracut linux linux-firmware ostree btrfs-progs cpio e2fsprogs xfsprogs dosfstools skopeo dbus dbus-glib glib2 ostree shadow && pacman -S --clean --noconfirm
